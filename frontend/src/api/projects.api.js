...
export const useUpdateProject = () => {
  ...
  return useMutation({
    ...
    onSuccess: (_, { id }) => { qc.invalidateQueries(['projects']); qc.invalidateQueries(['project', id]); toast.success('Project updated') },
    onError: (err) => toast.error(err.response?.data?.message || 'Failed'),
  })
}
...
export const useArchiveProject = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries(['projects']); toast.success('Project archived') },
  })
}
...
export const useAddMember = (projectId) => {
  ...
  return useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries(['project', projectId]); toast.success('Member added') },
    onError: (err) => toast.error(err.response?.data?.message || 'Failed'),
  })
}
